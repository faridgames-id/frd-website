...
const GlowCard = ({ children, className }: { children: React.ReactNode, className?: string }) => (
  <div className={`relative group isolate rounded-2xl w-full flex flex-col p-[1px] overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_15px_40px_-10px_rgba(79,142,247,0.3)] ${className || ''}`}>
    ...
    <div className="h-full w-full bg-gradient-to-br from-[#0d1326]/95 to-[#050811]/95 rounded-[15px] p-6 lg:p-8 relative z-10 flex flex-col justify-between items-start border border-blue-500/20 group-hover:border-blue-400/50 transition-colors shadow-2xl">
...
<section className="slide-section py-16 lg:py-24 flex-col min-h-[100dvh] w-full relative overflow-hidden flex justify-center items-center snap-center bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-[#0018cc]/50 via-[#000744]/25 to-transparent" id="komunitas">
  <div className="absolute inset-0 z-0 pointer-events-none will-change-transform"><Particles /></div>
...
{/* ── SERVICES ── */}
<section className="slide-section py-16 lg:py-24 flex-col min-h-[100dvh] w-full relative overflow-hidden flex justify-center items-center snap-center bg-[radial-gradient(circle_at_left,_var(--tw-gradient-stops))] from-[#002bff]/50 via-[#000d77]/25 to-transparent" id="services">
  <div className="absolute inset-0 z-0 pointer-events-none will-change-transform"><Particles /></div>
  ...
  <div className="max-w-7xl mx-auto px-4 lg:px-8 w-full z-20 relative">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
      ...
      <div className="group animate-floating relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#0d1326]/90 to-[#050811]/90 border border-slate-800/80 hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(59,130,246,0.3)]">
        ...
        <div className="relative p-6 lg:p-8 z-10 flex flex-col h-full">
...
{/* ── TRANSACTION FLOW ── */}
<section className="slide-section py-16 lg:py-24 flex-col min-h-[100dvh] w-full relative overflow-hidden flex justify-center items-center snap-center bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#0022ff]/50 via-[#000a55]/25 to-transparent" id="flow">
  <div className="absolute inset-0 z-0 pointer-events-none will-change-transform"><Particles /></div>
...
{/* ── TRUST ── */}
<section className="slide-section py-16 lg:py-24 flex-col min-h-[100dvh] w-full relative overflow-hidden flex justify-center items-center snap-center bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#0018cc]/50 via-[#000744]/25 to-transparent" id="trust">
  <div className="absolute inset-0 z-0 pointer-events-none will-change-transform"><Particles /></div>
...
{/* ── CTA / NEWSLETTER ── */}
<section className="slide-section py-16 lg:py-24 flex-col min-h-[100dvh] w-full relative overflow-hidden flex justify-center items-center snap-center bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-[#002bff]/50 via-[#000d77]/25 to-transparent" id="contact">
  <div className="absolute inset-0 z-0 pointer-events-none will-change-transform"><Particles /></div>
